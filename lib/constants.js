...
// Convert Google Drive URL to proxied image URL
export function convertDriveUrl(url) {
  ...
  for (const pattern of patterns) {
    ...
    if (match) {
      // Route through our proxy to avoid referrer/CORS blocking
      const directUrl = `https://lh3.googleusercontent.com/d/${match[1]}=s800`;
